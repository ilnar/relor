...
var file_api_workflow_proto_rawDesc = []byte{
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x9e, 0x01,
	0x0a, 0x0f, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x2a, 0x0a, 0x03, 0x52, 0x75, 0x6e, 0x12, 0x0f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x52,
	0x75, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x61, 0x70, 0x69, 0x2e,
...
var file_api_workflow_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_api_workflow_proto_goTypes = []interface{}{
	...
	(*graph.Graph)(nil),    // 7: graph.Graph
}
var file_api_workflow_proto_depIdxs = []int32{
	7, // 0: api.RunRequest.graph:type_name -> graph.Graph
	...
	5, // 4: api.WorkflowService.Update:input_type -> api.UpdateRequest
	2, // 5: api.WorkflowService.Run:output_type -> api.RunResponse
	4, // 6: api.WorkflowService.Get:output_type -> api.GetResponse
	6, // 7: api.WorkflowService.Update:output_type -> api.UpdateResponse
