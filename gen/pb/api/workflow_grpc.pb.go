...
const (
	WorkflowService_Run_FullMethodName     = "/api.WorkflowService/Run"
	WorkflowService_Get_FullMethodName     = "/api.WorkflowService/Get"
	WorkflowService_History_FullMethodName = "/api.WorkflowService/History"
	WorkflowService_Update_FullMethodName  = "/api.WorkflowService/Update"
)
...
func (c *workflowServiceClient) History(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*HistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkflowService_History_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WorkflowService_History_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorkflowService_History_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
